        ...
        <div class="col-lg-5">
            <?php $form = ActiveForm::begin(['id' => 'login-form']); ?>
                ...
                <div class="form-group">
                    <?= Html::submitButton(Yii::t('users', 'Войти'), ['class' => 'btn btn-primary', 'name' => 'login-button']) ?>
                </div>
            <?php ActiveForm::end(); ?>
        </div>
        <div class="col-lg-7">
            <p><?= Yii::t('users', 'Вы можете войти с помощью социальных сетей')?></p>
            <?= AuthChoice::widget([
