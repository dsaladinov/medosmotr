...
<div class="site-signup">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <div><?= $form->field($model, 'user_type')->dropDownList(User::getUserTypeArray())?></div>
    ...
    <div class="form-group">
        <?= Html::submitButton(Yii::t('users', 'Регистрация'), ['class' => 'btn btn-primary', 'name' => 'signup-button']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
