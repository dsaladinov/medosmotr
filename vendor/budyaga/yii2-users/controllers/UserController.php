                ...
                'rules' => [
                    ...
                    [
                        ...
                        'matchCallback' => function ($rule, $action) {
                            return Yii::$app->user->can('userUpdateNoElderRank', ['user' => $this->findModel(Yii::$app->request->get('id'))]);
                        }
                    ],
                    [
                        'allow' => true,
                        'actions' => ['delete'],
                        'matchCallback' => function ($rule, $action) {
                            return Yii::$app->user->can('userDelete', ['article' => $this->findModel(Yii::$app->request->get('id'))]);
                        }
                    ],
                ],
            ],
